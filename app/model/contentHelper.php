...
class contentHelper extends Database {
    ...
    function getwebex()
    {
        ...
        $query = "SELECT id_webex, topic, speaker, DATE_FORMAT(schedule,'%d %b %y') as schedule, picture, site, meeting_number, TIME_FORMAT(waktu, '%h:%i %p') as waktu from webex where status= '1'";
        //pr($query);
